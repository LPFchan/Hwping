...
Once an item has been reflected into `SPEC.md`, `STATUS.md`, `PLANS.md`, `research/`, `records/decisions/`, commit-backed execution history, `upstream-intake/`, or a deliberate discard/hold note, remove the inbox entry.
