...
Use this template during a periodic Hwping upstream intake review.
Use the same template when one candidate needs escalation as a standalone decision packet.
...
- What user or maintainer problem does this change solve upstream?
- What assumptions from upstream do not carry over cleanly to Hwping?
...
- FFI, app, extension, or public contract compatibility checked:
