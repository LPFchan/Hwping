...
- Keep it easy to append to from chat, operator notes, or agent capture.
...
No active `IBX-*` items are open right now.
...
Once an item has been reflected into `SPEC.md`, `STATUS.md`, `PLANS.md`, `research/`, `records/decisions/`, `records/agent-worklogs/`, or `upstream-intake/`, remove the inbox entry.
